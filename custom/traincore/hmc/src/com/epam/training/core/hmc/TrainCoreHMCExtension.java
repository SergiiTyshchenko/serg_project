...
/**
 * Provides necessary meta information about the traincore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class TrainCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(TrainCoreHMCExtension.class.getName());
