...
import com.epam.training.test.constants.TrainTestConstants;
 ...
 */
@SystemSetup(extension = TrainTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/traintest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/traintest/import/reviews.impex");
			...
			importImpexFile(context, "/traintest/import/cstickets.impex");
		}
	}
}
